  ...
  const buttonHtml = link
    ? `<table cellpadding="0" cellspacing="0" style="margin:0 0 24px;">
            <tr><td style="background-color:#18181b;border-radius:6px;padding:12px 24px;">
              <a href="${link}" style="color:#ffffff;font-size:14px;font-weight:500;text-decoration:none;display:inline-block;">View Details</a>
            </td></tr>
          </table>`
    : '';
    ...
    <tr><td align="center">
      <table width="100%" cellpadding="0" cellspacing="0" style="max-width:480px;background-color:#ffffff;border-radius:8px;overflow:hidden;">
        <tr><td style="padding:32px 32px 24px;">
          <h1 style="margin:0 0 8px;font-size:20px;font-weight:600;color:#18181b;">b0t Notification</h1>
          <p style="margin:0 0 4px;font-size:16px;font-weight:500;color:#18181b;">${title}</p>
          <p style="margin:0 0 24px;font-size:15px;line-height:1.6;color:#3f3f46;">${message}</p>
          ${buttonHtml}
          <p style="margin:0;font-size:13px;color:#71717a;">
            You can manage your notification preferences in b0t settings.
          </p>
        </td></tr>
      </table>
    </td></tr>
