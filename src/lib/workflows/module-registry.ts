  ...
  return [
    {
      ...
      modules: [
        {
          name: 'agent-tool-resolver',
          functions: [
            {
              name: 'resolveAgentTools',
              description: 'Resolve agent tools based on the provided options.',
              signature: 'resolveAgentTools(options?, customTools?)',
            },
          ],
        },
        {
        ...
        },
        {
          ...
          functions: [
            ...
            {
              name: 'vision',
              description: 'Execute vision',
              signature: 'vision(input)',
            },
            {
              name: 'embeddings',
              description: 'Execute embeddings',
              signature: 'embeddings(input)',
            },
          ],
        },
        {
        ...
        },
        {
          ...
          functions: [
            {
              name: 'storeFact',
              description: 'Store a memory fact from a workflow',
              signature:
                'storeFact(category, subject, content, metadata?, userId?, organizationId?)',
            },
            {
              name: 'searchMemories',
              description: 'Search memories using hybrid search (vector + keyword)',
              signature: 'searchMemories(query, topK?, userId?, organizationId?)',
            },
            {
              name: 'deleteFact',
              description: 'Delete a memory fact',
              signature: 'deleteFact(factId, userId?, organizationId?)',
            },
            {
              name: 'getFactsContext',
              description: 'Get all facts as context string (formatted markdown)',
              signature: 'getFactsContext(userId?, organizationId?)',
            },
          ],
        },
        {
        ...
        },
        {
          ...
          functions: [
            ...
            },
            {
              ...
              description: 'Execute searchAndAnswer',
              signature: 'searchAndAnswer(input)',
            },
            {
              name: 'generateText',
              description:
                'Generate text using Perplexity AI (legacy — prefer chat or searchAndAnswer)',
              signature: 'generateText(input)',
              example:
    ...
    },
    {
      ...
      modules: [
        ...
        },
        {
          ...
          functions: [
            {
              name: 'getResendFromEmail',
              description: 'Execute getResendFromEmail',
              signature: 'getResendFromEmail()',
            },
            {
              name: 'sendEmail',
        ...
        },
        {
          ...
          functions: [
            ...
            },
            {
              name: 'sendText',
              description: 'Send simple text message (convenience)',
              signature: 'sendText(channel, text, token?)',
            },
            {
              name: 'uploadFile',
      ...
      modules: [
        ...
        },
        {
          ...
          functions: [
            ...
            {
              name: 'downloadFile',
              description: 'Execute downloadFile',
            ...
            {
              name: 'listFolder',
              description: 'Execute listFolder',
              signature: 'listFolder(input)',
            },
            {
              name: 'createFolder',
            ...
            {
              name: 'moveFile',
              description: 'Execute moveFile',
              signature: 'moveFile(input)',
            },
            {
              name: 'copyFile',
              description: 'Execute copyFile',
              signature: 'copyFile(input)',
            },
            {
              name: 'createSharedLink',
              description: 'Execute createSharedLink',
              signature: 'createSharedLink(input)',
            },
            {
              name: 'listSharedLinks',
              description: 'Execute listSharedLinks',
              signature: 'listSharedLinks(input)',
            },
            {
              name: 'search',
              description: 'Execute search',
        ...
        },
        {
          ...
          functions: [
            {
              name: 'gbpListAccounts',
              description: 'Execute gbpListAccounts',
              signature: 'gbpListAccounts(input)',
            },
            {
              name: 'gbpListLocations',
              description: 'Execute gbpListLocations',
              signature: 'gbpListLocations(input)',
            },
            {
              name: 'gbpGetLocation',
              description: 'Execute gbpGetLocation',
              signature: 'gbpGetLocation(input)',
            },
            {
              name: 'gbpUpdateLocation',
              description: 'Execute gbpUpdateLocation',
              signature: 'gbpUpdateLocation(input)',
            },
            {
              name: 'gbpListReviews',
              description: 'Execute gbpListReviews',
              signature: 'gbpListReviews(input)',
            },
            {
              name: 'gbpReplyToReview',
              description: 'Execute gbpReplyToReview',
              signature: 'gbpReplyToReview(input)',
            },
            {
              name: 'gbpDeleteReviewReply',
              description: 'Execute gbpDeleteReviewReply',
              signature: 'gbpDeleteReviewReply(input)',
            },
            {
              name: 'gbpListMedia',
              description: 'Execute gbpListMedia',
              signature: 'gbpListMedia(input)',
            },
            {
              name: 'gbpUploadMedia',
              description: 'Execute gbpUploadMedia',
              signature: 'gbpUploadMedia(input)',
            },
            {
              name: 'gbpDeleteMedia',
              description: 'Execute gbpDeleteMedia',
              signature: 'gbpDeleteMedia(input)',
            },
          ],
        },
        {
        ...
        },
        {
          ...
          functions: [
            {
              name: 'insertRow',
              description: 'Execute insertRow',
              signature: 'insertRow(input)',
            },
            {
              name: 'updateRow',
              description: 'Execute updateRow',
              signature: 'updateRow(input)',
            },
            {
              name: 'deleteRow',
              description: 'Execute deleteRow',
              signature: 'deleteRow(input)',
            },
            {
              name: 'selectRows',
              description: 'Execute selectRows',
              signature: 'selectRows(input)',
            },
            {
              name: 'upsertRow',
              description: 'Execute upsertRow',
              signature: 'upsertRow(input)',
            },
            {
              name: 'rpc',
              description: 'Execute rpc',
              signature: 'rpc(input)',
            },
          ],
        },
      ...
      modules: [
        ...
        },
        {
          ...
          functions: [
            ...
            {
              name: 'executeAsync',
              description: 'Execute async JavaScript code in a sandboxed worker thread.',
